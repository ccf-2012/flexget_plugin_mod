...
def register_plugin():
    plugin.register(OutputQBitTorrentMod, 'qbittorrent_mod', api_ver=2)
    plugin.register(FromQBitTorrentMod, 'from_qbittorrent_mod', api_ver=2)
