...
class InputDelugeMod(DelugeModPlugin):
...
class OutputDelugeMod(DelugeModPlugin):
...
def register_plugin():
    plugin.register(InputDelugeMod, 'from_deluge_mod', api_ver=2)
    plugin.register(OutputDelugeMod, 'deluge_mod', api_ver=2)
